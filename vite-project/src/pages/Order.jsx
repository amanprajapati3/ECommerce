      ...
      <div className="md:mx-20 mx-5 mt-5">
        <div>
          <div className="flex justify-center mb-5 ml-2">
            <h1 className="text-left text-xl">MY <span className="font-bold">ORDERS</span></h1>
          ...
          {orderData.map((item, index) => (
            ...
            >
              <div className="md:flex  md:justify-start gap-3  md:w-[430px]">
                ...
                <div className="mt-5 ">
                  ...
                  <p className="ml-2 md:ml-0"> 
                    <b>Date : </b>
                    <span className="text-gray-700">{new Date(item.date).toDateString()}</span>
                  </p>
                   <p className="ml-2 md:ml-0"> 
                    <b>Payment : </b>
              ...
              <div className="md:mt-16 mt-2 h-fit w-fit  mr-5 ml-2">
                <p onClick={loadData} className="bg-pink-400 cursor-pointer px-2 py-1 rounded-md">Track Order</p>
              </div>
            </div>
          ))}
          </div>
